...
test('routes current time to utility before web search', async () => assert.equal((await routeCapability('Current time in India kya hai?', hybrid)).capability,'utility'));
test('routes today date to utility', async () => assert.equal((await routeCapability('Aaj ki date kya hai?', hybrid)).capability,'utility'));
test('routes current prime minister to web search', async () => assert.equal((await routeCapability('Current prime minister kaun hai?', hybrid)).capability,'web_search'));
