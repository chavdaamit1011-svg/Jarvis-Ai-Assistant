        ...
        try {
          ...
          if (traceSession) await traceSession.update({
            structuredFactQuery: {
              ...
              outputMode: structured.outputMode,
              matchedProjectEntities: structured.matchedProjectEntities,
              relationshipMatches: structured.relationshipMatches,
              ...
              finalSelectedValues: structured.finalSelectedValues,
